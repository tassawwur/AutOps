...
class MockSlackClient:
    ...
    def post_message(self, channel: str, text: str = None, blocks: List[Dict] = None, **kwargs):
    ...
    def post_interactive_message(self, channel: str, text: str, actions: List[Dict], **kwargs):
        """Mock posting an interactive message."""
        return self.post_message(channel, text, actions)

    def update_message(self, channel: str, ts: str, text: str = None, blocks: List[Dict] = None):
        """Mock updating a message."""
        return self.post_message(channel, text, blocks)

    def create_approval_blocks(self, title: str, description: str, action_id: str, **kwargs):
        """Mock creating approval blocks."""
        return [{"type": "section", "text": {"type": "mrkdwn", "text": f"{title}: {description}"}}]

    def create_status_blocks(self, title: str, status: str, details: Dict[str, Any], **kwargs):
        """Mock creating status blocks."""
        return [{"type": "section", "text": {"type": "mrkdwn", "text": f"{title}: {status}"}}]
